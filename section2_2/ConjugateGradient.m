function [x, flag, relres, iter, resvec, ritz, xvec] = ConjugateGradient(A, b, tol, maxit, x0)
%
...
%   [x,flag,relres,iter,resvec, xvec] = ConjugateGradient(___)
%
%   INPUT ARGUMENTS
%   
...
%   xvec   - trajectory of iteration process
%
%   FLAG VALUES
%   
