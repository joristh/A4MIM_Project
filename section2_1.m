...
set(gca,'YTickLabel',[]);
box on
exportgraphics(gcf,'plots/sec2_1_eigvals.pdf','ContentType','vector')
...
ylim([1e-8, 10])
xlim([0, 50])
exportgraphics(gcf,'plots/sec2_1_convergence.pdf','ContentType','vector')
...
exportgraphics(gcf,'plots/sec2_1_ritzvalues.pdf','ContentType','vector')
